...
<form method="GET" action="{{ route('admin.orders.index') }}" class="mb-4 bg-light p-3 rounded shadow-sm">
    <div class="row g-2">
        ...
        <div class="col-md-12 text-end mt-2">
            ...
            <a href="{{ route('admin.orders.index') }}" class="btn btn-warning btn-sm"><i class="bi bi-arrow-clockwise"></i> Reset</a>
        </div>
    </div>
</form>
...
<div class="table-responsive shadow-sm rounded">
    ...
    @if($order->reference_image)
        <a href="{{ asset('storage/' . $order->reference_image) }}" target="_blank">View</a>
    @else
